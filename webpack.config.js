/**
 * Assets Config file
 * Getting started: change ever instance of "webpackstartertheme" to the name of your local web.
 */
...
const browserSyncSettings = {
  ...
  proxy: 'archvalerandomizer.local',
  ...
  urlOverride: /archvalerandomizer\.local/g
};
  ...
  return {
    ...
    plugins: [
      new BrowserSyncPlugin({
        files: '**/*.php',
        host: browserSyncSettings.host,
        port: browserSyncSettings.port,
        proxy: browserSyncSettings.proxy,
        rewriteRules: [
            {
                match: browserSyncSettings.urlOverride,
                fn: function (req, res, match) {
                    return browserSyncSettings.host + ':' + browserSyncSettings.port;
                }
            }
        ],
        ghostMode: {
